...
class StudentProfilesControllerTest < ActionController::TestCase
  ...
  test "should create student_profile" do
    assert_difference('StudentProfile.count') do
      post :create, student_profile: { clinical_school: @student_profile.clinical_school, name: @student_profile.name, year: @student_profile.year }
    end
  ...
  test "should update student_profile" do
    patch :update, id: @student_profile, student_profile: { clinical_school: @student_profile.clinical_school, name: @student_profile.name, year: @student_profile.year }
    assert_redirected_to student_profile_path(assigns(:student_profile))
  end
